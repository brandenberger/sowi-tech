...
```{}
Name, Vorname und Vorname Name. Jahr. Titel des Papers. Titel des Journals
...
Ist der Autor/Autorin nicht klar, so gilt als erstes abzuklären, ob die Quelle tatsächlich brauchbar und nötig ist. Idealerweise sollte die Quelle durch eine andere ersetzt werden. 
