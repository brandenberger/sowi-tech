...
Belege oder Zitate werden auch gebraucht um Ideen oder Befunde von eigenen Resultaten abzugrenzen. Aller Text ohne Quellenangabe wird als euer Beitrag zur Literatur angesehen. Fehlen Quellenangaben so begeht man ein Plagiat (siehe Kapitel \@ref(plagiate)).
...
Fussnoten werden in den Sozialwissenschaften nur selten als Quellenangabe verwendet und muss auf jeden Fall vom Dozierenden abgesegnet werden. 
...
* Der Himmel ist blau.
* Herr Schneider-Amman ist 2016 Bundespräsident.
...
Hierfür verwendet man Anführungs- und Schlusszeichen. Alles was zwischen den Anführungs- und Schlusszeichen steht darf nicht verändert werden. Auch Rechtschreibefehler, Formatierungen etc. müssen vom Original übernommen werden.
...
Direkt nach dem Zitat erfolgt die Kennzeichungn der Quelle.
...
Paraphrasen sind sinngemässe Übernahmen einer Textpassage aus einem anderen Dokument. Hierfür braucht es keie direkte Kennzeichung (z.B. Anführungszeichen) aber die Quelle erfolgt direkt nach der Paraphrase.
